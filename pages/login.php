...
<aside class="sidebar" aria-hidden="true">
    ...
    <div class="auth-container">
        <form class="auth-form" method="POST" action="../php/login.php" novalidate>
            ...
            <input type="email" id="email" name="email" class="auth-input" required autocomplete="username" />
            ...
            <p class="auth-footer">Bạn chưa có tài khoản? <a href="register.php" class="auth-link">Đăng ký</a></p>
        </form>
    </div>
</body>
</html>
